...
@Suppress("unused")
object ForTea.RiderModel : Ext(SolutionModel.Solution) {
    ...
    init {
        //setting(CSharp50Generator.Namespace, "ReSharperPlugin.ForTea.Rider.Rider.Model")
        //setting(Kotlin11Generator.Namespace, "com.jetbrains.rider.fortea.rider.model")
